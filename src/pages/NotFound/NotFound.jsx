...
import PlanetSvg from '~/assets/NotFoundPage/planet.svg?react'
import AstronautSvg from '~/assets/NotFoundPage/astronaut.svg?react'
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        width: '100%',
        height: '100%',
        backgroundImage: 'url("src/assets/NotFoundPage/particles.png")',
